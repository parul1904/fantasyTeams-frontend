...
import { updateStats, getStatsById } from '../../../services/admin/StatsService';
import { getSeasons, getMatches, getPlayers } from '../../../services/admin/DropDownService';
import { getMatchDetails } from '../../../services/admin/MatchService';

const EditStatsComponent = () => {
    ...
    return (
        <div className="container mt-4">
            <h2 className="text-center mb-4">Edit Match Statistics</h2>
            <form>
                {/* Player Section */}
                            ...
                            <div className="col-md-4">
                                <div className="form-group">
                                    ...
                                    <Select
                                        ...
                                        value={seasons.find(season => season.value === stats.seasonId)}
                                        isClearable
                                    />
                                </div>
                            </div>
                            <div className="col-md-4">
                                <div className="form-group">
                                    ...
                                    <Select
                                        ...
                                        className="basic-single"
                                        classNamePrefix="select"
                                        value={matches.find(match => match.value === stats.matchId)}
                                        isClearable
                                    />
                                </div>
                            </div>
                            ...
                            <div className="col-md-4">
                                <div className="form-group">
                                    ...
                                    <Select
                                        ...
                                        className="basic-single"
                                        classNamePrefix="select"
                                        value={players.find(player => player.value === stats.playerId)}
                                        isClearable
                                    />
                                </div>
                            </div>
                ...
                <div className="text-center">
                    <button className="btn btn-primary btn-lg" onClick={saveStats}>Update Statistics</button>
                </div>
            </form>
        </div>
    );
...
export default EditStatsComponent;