...
import { listSquadsByTeam } from "../../../services/admin/SquadService";
  ...
  return (
    <div className="container mt-4">
      <div className="row mb-4 justify-content-center">
        {teams
          .filter((team) => team.teamName !== "TBD")
          .map((team) => (
            <div className="col-4 col-sm-3 col-md-2 col-lg-1 mb-1 position-relative" key={team.teamId}>
              <div className="team-logo-container">
                ...
                {selectedTeam === team.teamId && (
                  <i
                    className="fas fa-check-circle position-absolute"
                    style={{
                      top: "10px",
                      right: "10px",
                      color: "orange",
      ...
      {teamDetails && (
        <div className="card mb-4">
          <div className="card-header bg-primary text-white">Team Details</div>
          <div className="card-body">
            <div className="row">
              ...
              <div className="col-md-3">
                ...
                <p>
                  <img
                    src="https://fantasyteams.s3.ap-south-1.amazonaws.com/others/team-trophy.png"
                    alt="Trophy"
                  />{" "}
                  {teamDetails.titleWon}
                </p>
              </div>
              <div className="col-md-6">
                <p>
                  <strong>Captain:</strong> {teamDetails.teamCaptain}
                </p>
                <p>
                  <strong>Coach:</strong> {teamDetails.teamCoach}
                </p>
                <p>
                  <strong>Venue:</strong> {teamDetails.teamVenue}
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="card mb-4" key={category}>
              <div
                className={`card-header bg-${
                  category === "Staff" ? "secondary" : "success"
                } text-white`}
              >
                {category}
              </div>
              <div className="card-body">
                <div className="row">
                  {categorizedPlayers[category].map((player) => (
                    <div className="col-6 col-sm-4 col-md-3 col-lg-2 mb-3" key={player.playerName}>
                      <div
                      ...
                      >
                        ...
                        {player.playerCountry !== "India" && (
                          <i
                            className="fas fa-plane position-absolute"
                            style={{
                              top: "10px",
                              right: "10px",
                              color: "red",
